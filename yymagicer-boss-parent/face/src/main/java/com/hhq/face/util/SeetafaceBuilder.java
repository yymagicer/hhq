...
import com.hhq.face.mapper.FaceDao;
import com.hhq.face.po.FaceIndex;
import com.hhq.face.po.SeetaImageData;
import com.hhq.face.service.SeetaFaceService;
import com.hhq.face.sqlite.JdbcPool;
...
public class SeetafaceBuilder {
    ...
    private volatile static SeetaFaceService seeta = null;
    ...
    public static SeetaFaceService build() {
        if (seeta == null) {
    ...
    private static void register(String key, FaceIndex face) {
        ...
        imageData.setData(face.getImgData());
