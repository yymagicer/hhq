...
public class AipAdded extends AipImageClassify{
	...
	//地标识别
	static final String LANDMARK_URL="https://aip.baidubce.com/rest/2.0/image-classify/v1/landmark";
	//红酒识别
	static final String REDWINE_URL="https://aip.baidubce.com/rest/2.0/image-classify/v1/redwine";
	//驾驶行为识别
	 ...
	 * @return JSONObject
	 */
    public JSONObject landmarkDetect(String image, HashMap<String, String> options) {
    	AipRequest request = new AipRequest();
    	preOperation(request);
    	try {
            byte[] data = Util.readFileByBytes(image);
	 ...
	 * @return JSONObject
	 */
    public JSONObject redwineDetect(String image, HashMap<String, String> options) {
    	AipRequest request = new AipRequest();
    	preOperation(request);
    	try {
            byte[] data = Util.readFileByBytes(image);
	 ...
	 * @return JSONObject
	 */
    public JSONObject driverBehaviorDetect(String image, HashMap<String, String> options) {
    	AipRequest request = new AipRequest();
    	preOperation(request);
    	try {
            byte[] data = Util.readFileByBytes(image);
